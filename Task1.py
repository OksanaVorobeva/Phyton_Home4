...
count_n=int(input("Введите количество элементов первого множества: "))
count_m=int(input("Введите количество элементов второго множества: "))
...
for i in range(count_m):
    list_2.append(int(input("Введите целое число: ")))
print(list_2)
list_1=set(list_1)
list_2=set(list_2)
